...
auto.train(data,n_iters=int(options.iters),record_weigth=True,model_name=options.model_name,batch=bat,display=False,noise=False,gradient=options.gradient,learning_rate=float(options.learn_rate))
